...
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","base.rb")
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","resource.rb")
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","users.rb")
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","store.rb")
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","system.rb")
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","sources.rb")
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","read_state.rb")
require File.join(File.dirname(__FILE__),"../lib/rhoconnect/api","clients.rb")

describe Rhoconnect::API do
  include WebMock::API
  ...
  context "on base" do
    it "should get token and url from env" do
      Rhoconnect::API::Base.token.should == 'mytoken'
      Rhoconnect::API::Base.resource.to_s.should == 'http://mytoken@testurl.com/rc/v1'
    end
  end
  context "on users" do
    it "should format get request url" do
      resp = Rhoconnect::API::Users.get
      resp.body.should == 'testuser'
    end
    
    it "should format post request" do
      data = {:id=>'1'}
      resp = Rhoconnect::API::Users.post('testuser',data)
      resp.body.should == 'testuser'
    end
    
    it "should format put request" do
      data = {:id=>'1'}
      resp = Rhoconnect::API::Users.put('testuser',data)
      resp.body.should == 'testuser'
    end
    
    it "should format delete request" do
      resp = Rhoconnect::API::Users.delete('testuser')
      resp.body.should == 'testuser'
    end
    
    it "should format user clients" do
      resp = Rhoconnect::API::Users.get_clients('testuser')
      resp.body.should == 'clientslist'
    end
    
    it "should format user sources docname" do
      resp = Rhoconnect::API::Users.get_sources_docnames(['testuser','product'])
  ...
  context "read state" do
    it "should return readsate for user" do
      ...
      resp = Rhoconnect::API::ReadState.post_users_sources(['testuser','product'],data)
  ...
  context "on system" do
    it "should login to system" do
      ...
      resp = Rhoconnect::API::System.post_login(data)
      resp.body.should == 'login'
    end
    
    it "should get appserver" do
      resp = Rhoconnect::API::System.get_appserver
  ...
  context "on store" do
    it "should store doc" do
      ...
      resp = Rhoconnect::API::Store.post('testdoc',data)
      resp.body.should == 'post store'
    end
    
    it "should get store doc" do
      resp = Rhoconnect::API::Store.get('testdoc')
  ...
  context "on client" do
    it "should get client sources docnames" do
      resp = Rhoconnect::API::Clients.get_sources_docnames(['client_id','source_id'])
      resp.body.should == 'client sources docname'
    end
    
    it "should get clients docs" do
      resp = Rhoconnect::API::Clients.get_sources_docs(['client_id','source_id','docname'])
      resp.body.should == 'client sources docs'
    end
    
    it "should post clients sources doc" do
      data = {:data=>{:mydata=>'testdata'},:append=>'false'}
      resp = Rhoconnect::API::Clients.post_sources_docs(['client_id','source_id','docname'],data)
  ...
  context "on resources" do
    it "should push source objects" do
      data = {:data=>{:mydata=>'testdata'},:append=>'false'}
      resp = Rhoconnect::API::Resource.post_push_objects('Product',data)
